...
\begin{document}
    ...
    \begin{tcolorbox}
        ...
        \begin{minipage}{0.9\textwidth} % Name and Contact Info
            ...
            % \name{Ian Soledade}{Innovative aerospace engineering student enrolled in the Georgia Tech BS/MS Honors Program with junior standing. Seeking to leverage STEM experience through an undergraduate research opportunity in an academic environment.} % Name and Profession
        ...
        \begin{minipage}[t]{0.825\textwidth} % Main Panel (e.g. Education, Work Experience)
            \begin{tcolorbox}[grow to right by=0.95cm,height=0.85\textheight,colframe=white,colback=white]
                ...
                \section*{\Large{Experience}}
                    ...
                    \work{\href{https://ccl.gatech.edu}{Computational Combustion Laboratory}}{Aug 2024 - Present}{Georgia Institute of Technology}{

                        \begin{itemize}
                        
                            \item Creating novel 3D visualizations and animations of flow patterns, vorticity effects, and shockwave propagation through rotating detonation engines.
                            ...
                            \item Working with fellow undergraduate researchers and research engineers to write a report summarizing completed visualization tasks.
                    ...
                    \work{\href{https://www.lockheedmartin.com/en-us/products/next-generation-interceptor.html}{Lockheed Martin Space, Engineering Intern}}{May 2024 - Aug 2024}{Next Generation Interceptor Program, Deer Creek Site}{
                        ...
                        \begin{itemize}
                            ...
                            \item Managed a project automating key validation tasks, greatly streamlining the electromechanical assembly verification process and pulling in project deadlines, correlating directly to increased award fees.

                            \item Presented uncontrolled aspects of project to a virtual corporate tech forum for all of PMP engineering at Lockheed Martin Space.
                    ...
                    \work{\href{https://ramblinrocketclub.org}{Ramblin' Rocket Club}}{Aug 2023 - Present}{Georgia Tech Student Organization}{

                        \begin{itemize}

                            \item Competed in a design contest for an N-class rocket motor, utilizing solid fuel. Devised a novel hybrid nozzle constructed out of zirconia and aluminum with significant performance/manufacturing benefits.

                            \item Working as PR/Outreach lead for the NASA Student Launch Initiative competition team, handling STEM engagement of students within Georgia as well as sponsorship materials and social media.

                            \item Managing engineering competition for high school students to design and build electronic rocket payloads for data collection, including facilitation of preliminary and critical design reviews.
                ...
                \section*{\Large{Education}}
                    ...
                    \education{\href{https://ae.gatech.edu/bsms-honors-program}{In-progress BS/MS, Aerospace Engineering}}{Aug 2023 - Present}{Georgia Institute of Technology}{GPA: 3.8}{\begin{itemize}

                        \item Currently enrolled: Aerodynamics, 3D Dynamics, Organizational Behavior, Technical Writing, Experimental Methods in Aerospace, and undergraduate research.
                    
                        \item Fully satisfied all core requirements (save humanities) for a BS degree, with 72 total credits earned. Expecting 89 credits by the end of Fall 2024.

                        \item Accepted into the BS/MS honors program, on track to receive MS degree in aerospace engineering within a year of BS graduation date.

                        \item Pursuing a business minor in leadership studies, learning valuable leadership and collaboration skills. 

                        \item Actively involved in multiple on-campus organizations such as AIAA, GT Taido (Karate), Cloudman chess club, GT Dungeons and Dragons club, and a nationwide political organization.
